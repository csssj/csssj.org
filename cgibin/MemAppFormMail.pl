...
sub send_mail {
    ...
    print MAIL "The CSSSJ on-line membership application form was filled out on\n";
    print MAIL "$date. The data that was entered into the form is as follows:\n";
    print MAIL "-" x 95 . "\n\n";

    print MAIL "Applicant's Email: $Config{'email'}\n\n";
    if (@Print_Config) {
    ...
    # BGG - Send a response email to applicant.                             #
    open(MAIL,"|$mailprog");

    print MAIL "To: $Config{'email'} ($Config{'realname'})\n";
    print MAIL "From: $Config{'recipient'}\n";
    print MAIL "Subject: RE: Your CSSSJ Membership Application\n\n";
    print MAIL "Dear $Form{'Name'},\n\n";
    print MAIL "Thank for your interest in joining or renewing your membership \n";
    print MAIL "to the Cactus and Succulent Society of San Jose.  To complete \n";
    print MAIL "the application process, please mail your dues check to the \n";
    print MAIL "following address:\n\n";
    print MAIL "CSSSJ Membership\n";
    print MAIL "841 San Juan Drive\n";
    print MAIL "Sunnyvale, CA, 94085\n\n";
    print MAIL "The check should be made payable to CSSSJ, in the amount \n";
    print MAIL "shown below:\n\n";
    print MAIL "- Single Membership: 15.00\n";
    print MAIL "- Couples Membership: 20.00\n\n\n";
    print MAIL "Regards,\n\n";
    print MAIL "-Sandy (CSSSJ Membership Director)";
    close (MAIL);
